...
namespace CGPipelineClassLibrary
{
    public class Projection : IProjection
    {
        ...
        /// </summary>
        /// <param name="model">The model to have the perspective applied to it</param>
        ...
        public List<Dictionary<string, Line>> CreatePerspectiveFieldOfView(Model model, float angle, float nearplanedistance, float farplanedistance)
        {
